...
public class MatchesController {
    ...
    public String update(@PathVariable Long id,@RequestParam String name,@RequestParam String description,@RequestParam Double price,@RequestParam MatchType type,@RequestParam Long location) {
