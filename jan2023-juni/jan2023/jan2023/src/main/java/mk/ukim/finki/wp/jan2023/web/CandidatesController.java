...
public class CandidatesController {
    ...
    @GetMapping(path = "/candidates/add")
     ...
     * @return The view "form.html".
     */
    @GetMapping(path = "/candidates/{id}/edit" )
    ...
    public String create(@RequestParam String name, @RequestParam  String bio, @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate dateOfBirth, @RequestParam Gender gender, @RequestParam Long party) {
    ...
    public String update(@PathVariable Long id, @RequestParam String name, @RequestParam String bio, @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate dateOfBirth,@RequestParam Gender gender,@RequestParam Long party) {
     ...
     * @return The view "list.html".
     */
    @PostMapping(path = "/candidates/{id}/delete")
    ...
    @PostMapping(path = "/candidates/{id}/vote")
